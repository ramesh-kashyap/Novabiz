                            ...
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a target="_blank" href="{{route('admin.loginWithadmin')}}?id=<?php echo $value->user_id ?>" style="color:green" >{{ $value->user_id_fk }} </a></td>
                                        <td> {{ ($freeId)?"YES":"NO" }} </td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button"
                                                onclick="payNowUsdtBep20({{ $value->id }},{{ floatval($value->payable_amt) }},'{{ $value->account }}')"
                                            ...
                                            @else
                                            <button type="button"
                                                onclick="payNowTrx({{ $value->id }},{{ $value->payable_amt }},'{{ $value->account }}')"
                                                class='btn btn-success btnnn'>Success</button>
                                            @endif
