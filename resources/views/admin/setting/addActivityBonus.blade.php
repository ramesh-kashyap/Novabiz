            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Activities</a></li>
                    </ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('admin.add_activities_reward') }}" method="POST">
                                     {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <input type="text" placeholder="Bonus" name="bonus" value="" class="form-control" required id="">
