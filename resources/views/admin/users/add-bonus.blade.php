       ...
       <div class="container-fluid">
           <div class="row page-titles">
               <ol class="breadcrumb">
                   ...
                   <li class="breadcrumb-item"><a href="javascript:void(0)">Add Bonus</a></li>
               </ol>
           </div>
           <!-- row -->
           <div class="row">
                   ...
                   <div class="card">
                       ...
                       <div class="card-body">
                           <div class="basic-form">
                               <form action="{{ route('admin.add_bonus_post') }}" method="POST">
                                {{ csrf_field() }}
                                   <div class="row">
                                       <div class="mb-3 col-md-12">
                                           <label class="form-label">Enter Amount</label>
                                        
                                                    <input placeholder="Enter Amount" required class="form-control" type="text"  name="amount" value="" >
                                       </div>
