            ...
            <div data-v-e85f0186="" class="page-container">
                <div data-v-e85f0186="" class="scroll">
                    <div data-v-50763054="" class="container">
                        <div data-v-50763054="" class="title_heand">Bind Email</div>
                        <div data-v-50763054="" class="boxs">
                        <form method="post" action="{{ route('user.bindemail-action') }}">

                            {{ csrf_field() }}
                            <div data-v-50763054="" class="box">                                
                                <div data-v-50763054="" class="title">User ID</div>
                                <div data-v-50763054="" class="inp-con"><input data-v-50763054="" class="inp"
                                        type="text" readonly="" value="{{Auth::user()->username}}"></div>
                            </div>
                            <div data-v-50763054="" class="box">
                                <div data-v-50763054="" class="title">Email</div>                                
                                <div data-v-50763054="" class="inp-con">  
                                    <input data-v-50763054="" class="inp"  id="emailId" value="{{Auth::user()->email}}" type="email" name="emailId"  placeholder="Enter your email">
                                </div>
                            </div>
                            <div data-v-50763054="" class="box">
                                <div data-v-50763054="" class="title">Verification Code</div>
