...
<head>
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/index-Cm92gFG6.js">
...
<body class="">
    <div id="app" data-v-app="">
        ...
        <div data-v-e85f0186="" data-v-c654d101="" class="page" style="background-color: rgb(254, 254, 251);">
            ...
            <div data-v-6a9399e1="" id="tab" class="tabs">
                ...
                <div data-v-6a9399e1="" class="tab"> <a href="{{ route('user.Withdraw') }}"> <span
                            data-v-6a9399e1="">@lang('Withdraw Request') </a></span></div>
                <div data-v-6a9399e1="" class="tab first"><span data-v-6a9399e1="">@lang('Principle Withdraw')</span>
                </div>
            </div>
            <div data-v-e85f0186="" class="page-container">
                <div data-v-e85f0186="" class="scroll">
                    <div data-v-c654d101="" class="container">
                        <div data-v-c654d101="" class="title_heand">@lang('Principle Withdraw')</div>
                        <form action="{{ route('user.WithdrawRequestPrinciple') }}" method="POST">
                            {{ csrf_field() }}
                                                        @php
                                    use Carbon\Carbon;

                                    $start = Carbon::parse(Auth::user()->adate);
                                    $end = Carbon::now();
                            ...
                            <div data-v-c654d101="" class="box-con">
                                <div data-v-c654d101="" class="title">@lang('Payment Mode')</div>
                                <div data-v-c654d101="" class="inp-con">
                                    <div data-v-c654d101="" class="chainName">


                                        <img src="{{ asset('') }}assets/images/usdt.jpeg" alt="USDT BEP20" style="max-width: 32px; height: 22px; margin-top: 4px;"> 
                                        &nbsp;
                                        <input data-v-c654d101="" type="text" readonly name="paymentMode"
                                            id="pkg_amount" readonly value="USDT.BEP20" placeholder=""
   ...
   <input type="hidden" id="chargeAmt" value="{{ $chargeAmt }}">
                            ...
                            <div data-v-c654d101="" class="box-con">
                                ...
                                <div data-v-c654d101="" class="inp-con">
                                    <div data-v-c654d101="" class="chainName" style="width:100%">
                                        <input data-v-0a0a182e=""   @if(!empty(Auth::user()->usdtBep20)) readonly @endif type="text"  id="walletAddress"
                                    name="walletAddress"  value="{{Auth::user()->usdtBep20}}"nid="van-field-5-input" rows="1"
                                                class="van-field__control"
                                                style="height: 18px;">
                                    </div>
                                </div>                                 
                            </div>
                                <div data-v-c654d101="" class="title" style="margin-top:20px">@lang('Enter Amount')</div>
                                <div data-v-c654d101="" class="inp-con">
                        ...
                        <div data-v-c654d101="" class="tips-con">
                            <div data-v-c654d101="" class="title"><img data-v-c654d101=""
                                ...
                                Attention</div>
                            <div data-v-c654d101="" class="desc">● @lang('Each withdrawal usually takes up to 24-72
                                hours to reach your digital currency wallet').<br>
                                ● @lang('User can Withdraw BEP 20 only').<br>
                                ● @lang('User can first Withdraw in 0-30 days,Deduction Fee:
                                30%').<br>
                                ● @lang('User can first Withdraw in 31-60 days,Deduction Fee:
                                20%').<br>
                                ● @lang('User can first Withdraw in 60 and above,Deduction Fee:
                                10%').<br>
                                ...
                                <!-- ● @lang('Minimum withdrawal: 10 USDT; Maximum withdrawal: 50,000; Deduction Fee:
                                10%');<br> -->
            ...
            <script>
    $(function(){
        // Get the user's registration date from PHP
        let registeredDate = new Date("{{ Auth::user()->adate }}");
        let today = new Date();

        // Calculate how many days since registration
        let diffTime = Math.abs(today - registeredDate);
        ...
        $('input[name="amount"]').on('input', function () {
            ...
            var chargePercent = $('#chargeAmt').val();

           
            let feeAmount = amount * (chargePercent / 100);
            let actualAmount = amount - feeAmount;

            $('#chargefee').html(chargePercent + "%");
            $('#ActualAmount').html(actualAmount.toFixed(2) + " USDT");
        });
    });
</script>
