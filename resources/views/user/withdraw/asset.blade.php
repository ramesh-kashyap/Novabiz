...
.asset .asset-bot .bot-item .name[data-v-523582ec] {
    color: #000000;
...
.asset .asset-bot .bot-item .val[data-v-523582ec] {
    color: #000000;
    font-size: .32rem;
    font-style: normal;
    font-weight: 500;
                            ...
                            <div data-v-523582ec="" class="btn-card">
                                <div data-v-523582ec="" class="btn-con">
                                    ...
                                    <div data-v-523582ec="" class="btn"  onclick="location.href='{{ route('user.Withdraw') }}' "   style="cursor: pointer"                                    >
                                            ...
                                            <img data-v-523582ec=""
                                                src="{{asset('assets/images/withdraw.png')}}">
                            ...
                            <div data-v-a6b12d45="" data-v-cc30a32a="" class="list">
                                <div data-v-a6b12d45="" class="item">
                                    ...
                                    <div data-v-a6b12d45="" class="right">
                                        <div data-v-a6b12d45="" class="total">{{number_format(Auth::user()->principleBalance(),2)}}</div>
