...
.price {
  ...
  font-size: 14px;
                                        ...
                                        <h2 class="hello-jessica">@lang('HI'), {{ \Illuminate\Support\Str::limit(Auth::user()->name, 12, '..') }} <span
                                                class="wave">👋</span></h2>
                                    ...
                                    <div class="verify-section-main align-items-stretch h-100">
                                        <div class="amigo-box-main">
                                            <div class="plus-box-text-main">
                                                ...
                                                <p>Last 24 Hour Profit : <span
                                                        style="color: green">{{ currency() }}{{ number_format($todaysRoiSum, 2) }}</span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="transaction-buttons">
                                            <div class="transaction-button">
                                                <div class="icon-circle"  onclick="location.href='{{ route('user.invest') }}' ">
                                            ...
                                            <div class="transaction-button">
                                                <div class="icon-circle"  onclick="location.href='{{ route('user.Withdraw') }}' ">
                                                    <svg viewBox="0 0 448 512"
                                                        style="width: 18px; height: 18px; overflow: visible; opacity: unset; z-index: 1; fill: rgb(21, 25, 27);">
                                                        <path
                                            ...
                                            <div class="transaction-button" onclick="location.href='{{ route('user.level-team') }}'">
                                                <div class="icon-circle">
                                                    <img src="{{asset('assets/images/group.png')}}" alt="with" style="width: 18px; height: 18px; overflow: visible; z-index: 1;"/>
                                                </div>
                                                <p>team</p>
                                            </div>
                                            <div class="transaction-button"  onclick="location.href='{{ route('user.records') }}'">
                                                <div class="icon-circle">
                                        ...
                                        <div class="crypto-cards">
                                            <!-- BTC Card -->
                                            <div class="crypto-card" onclick="location.href='{{ route('user.share') }}'">
                                                <div class="top-row">
                                                    <div>
                                            ...
                                            <!-- XCN Card -->
                                            <div class="crypto-card" onclick="location.href='{{ route('user.activities') }}'">
                                                <div class="top-row">
                                                    <div>
                                    ...
                                    <!-- <div data-v-524186f8="" data-v-5ecfac1a="" class="home-router"><img
                                        ...
                                        <div data-v-524186f8="" class="box invite">
                                            <a href="{{ route('user.share') }}">
                                                <div data-v-524186f8="" class="box-top">
                                                    <h3 style="color:black;" data-v-524186f8="">@lang('Invite Friends')</h3>
                                                    <p data-v-524186f8="">@lang('Share DCXPRO Quantitative Bonus')</p>
                                                </div>
                                            </a>
                                        ...
                                        <div data-v-524186f8="" class="box task">
                                            <a href="{{ route('user.activities') }}">
                                                <div data-v-524186f8="" class="box-top">
                                                    <h3 style="color:black;" data-v-524186f8="">@lang('Task Center')</h3>
                                                    <p data-v-524186f8="">@lang('Complete Tasks for Rewards')</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div> -->
                                    ...
                                    <div data-v-dc73e05e="" data-v-5ecfac1a="" class="home-market">
                                        ...
                                        <div data-v-dc73e05e="" class="market-con first">
                                            ...
                                            <div data-v-dc73e05e="" class="tbody tr">
                                                ...
                                                <div data-v-dc73e05e="" class="td">
                                                    <div data-v-dc73e05e="" class="btn" id="btc-percentage">+0.37%
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-v-dc73e05e="" class="tbody tr">
                                                ...
                                                <div data-v-dc73e05e="" class="td">
                                                    <div data-v-dc73e05e="" class="btn" id="eth-percentage">+2.88%
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-v-dc73e05e="" class="tbody tr">
                                                ...
                                                <div data-v-dc73e05e="" class="td">
                                                    <div data-v-dc73e05e="" class="btn" id="doge-percentage">
                                                        +1.37%</div>
                                                </div>
                                            </div>
                                            <div data-v-dc73e05e="" class="tbody tr">
                                                ...
                                                <div data-v-dc73e05e="" class="td">
                                                    <div data-v-dc73e05e="" class="btn" id="ada-percentage">+2.00%
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-v-dc73e05e="" class="tbody tr">
                                                ...
                                                <div data-v-dc73e05e="" class="td">
                                                    <div data-v-dc73e05e="" class="btn" id="avax-percentage">
                                                        +2.90%</div>
                                                </div>
                ...
                <!-- <div data-v-8b363259="" data-v-e85f0186="" class="touch-move-con"
                    ...
                    <div data-v-a1dcde29="" data-v-e85f0186="" class="customer-service">
                        <a
                            href="https://t.me/DcxproWorld" target="_blank"> <img data-v-a1dcde29=""
                                src="{{ asset('') }}assets/images/2003266.png">
                            </a>
                        </div>
                </div> -->
            </div>
                        ...
                        if (exchange == "BINANCE") {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $('#btc-percentage').text(parseFloat(percentageChange).toFixed(2) + "%")
                                        .css('background', (percentageChange > 0) ? '#00bc81' : 'red');
                        ...
                        if (exchange == "BINANCE") {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $('#eth-percentage').text(parseFloat(percentageChange).toFixed(2) + "%")
                                        .css('background', (percentageChange > 0) ? '#00bc81' : 'red');
                        ...
                        if (exchange == "BINANCE") {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $('#doge-percentage').text(parseFloat(percentageChange).toFixed(2) + "%")
                                        .css('background', (percentageChange > 0) ? '#00bc81' : 'red');
                        ...
                        if (exchange == "BINANCE") {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $('#ada-percentage').text(parseFloat(percentageChange).toFixed(2) + "%")
                                        .css('background', (percentageChange > 0) ? '#00bc81' : 'red');
                        ...
                        if (exchange == "BINANCE") {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $('#avax-percentage').text(parseFloat(percentageChange).toFixed(2) + "%")
                                        .css('background', (percentageChange > 0) ? '#00bc81' : 'red');
