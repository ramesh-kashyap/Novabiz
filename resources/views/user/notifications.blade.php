                        ...
                        <div class="van-sticky" style="">
                            <div data-v-38c4ffa9="" class="tabs-con container">
                                <div data-v-38c4ffa9="" class="title_heand"
                                    style="margin-top: 0rem; padding-top: 0.12rem;">@lang('Notifications')</div>
                                ...
                                <div data-v-01110b5f="" data-v-38c4ffa9="" class="list">
                                  ...
                                  <?php if(is_array($notifications) || is_object($notifications)){ ?>
                                        ...
                                        @php
                                            ...
                                            // Group notifications by formatted date (e.g., 22/03/2025)
                                            $grouped = collect($notifications)->groupBy(function($item) {
                                                return \Carbon\Carbon::parse($item->created_at)->format('D, d M Y');
                                            });
                                        @endphp
                                    
                                        @foreach($grouped as $date => $items)
                                            <div class="fw-bold text-dark fs-6 my-3" style="
                                                    font-family: Barlow, sans-serif;
                                                    font-size: 15px;
                                                    line-height: 1.5;
                                                    font-weight: 900;margin-bottom: 10px;">{{ $date }}</div>
                                    
                                            @foreach($items as $value)
                                                <div data-v-01110b5f="" class="item">
                                                    <div data-v-01110b5f="" class="left">
                                                        <div data-v-01110b5f="" class="type">{{ $value->title }}</div>
                                                        <div data-v-01110b5f="" class="time">{{ \Carbon\Carbon::parse($value->created_at)->format('H:i:s') }}</div>
                                                        <div data-v-01110b5f="" class="time">{{ $value->message }}</div>
