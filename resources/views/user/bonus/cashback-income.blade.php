<div class="contentLk">
    ...
    <h2 class="titleLk">Matching Bonus</h2>
    <div class="historyPage">
        <form id="filter-form" class="filterBl" action="{{ route('user.matching-bonus') }}" method="GET">
                ...
                <div class="slideBlock branch1">
                    <div class="slideTitle" onclick="return clickRef(2, 1074);" id="el1074" data-level="1">
                        <div class="line">
                            ...
                            <span class="txt"> <span class="mobileTiTPart">Commission</span> {{currency()}} {{ $value->amt }}</span>
