                                    ...
                                    <div class="van-tabs__wrap">
                                        <div role="tablist"
                                            ...
                                            <div id="van-tabs-8-1" role="tab"
                                                ...
                                                aria-selected="false" aria-controls="van-tab-10"> <a href="{{route('user.records')}}"> <span
                                            ...
                                            <div id="van-tabs-8-3" role="tab"
                                                ...
                                                aria-selected="false" aria-controls="van-tab-12"> <a href="{{route('user.roi-bonus')}}"> <span
                                                    class="van-tab__text">@lang('Income')</span> </a></div>
                        ...
                        <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                            ...
                            <div data-v-3aad496f="" role="feed" class="van-list" aria-busy="false">
                                <div data-v-01110b5f="" data-v-38c4ffa9="" class="list">
                                    <br>
                                     <form action="{{route('user.roi-bonus')}}" method="GET" class="search-container" style="display: flex; align-items: center;">
                                      ...
                                      <!--  class="search-input"-->
                                      <!--  style="padding: 7px; border: 1px solid #ccc; border-radius: 8px 0 0 8px; outline: none; flex: 1;"-->
                                      <!--/>-->
                                      
                                      <select class="search-input" name="search">
                                        <option value="Quantify Income" {{ request('search') == 'Quantify Income' ? 'selected' : '' }}>Quantify Income</option>
                                        <option value="Quantify Level Income" {{ request('search') == 'Quantify Level Income' ? 'selected' : '' }}>Quantify Level Income</option>
                                        <option value="First Deposit Bonus" {{ request('search') == 'First Deposit Bonus' ? 'selected' : '' }}>First Deposit Bonus</option>
                                        <option value="Direct Commission" {{ request('search') == 'Direct Commission' ? 'selected' : '' }}>Direct Commission</option>
                                        <option value="Task Income" {{ request('search') == 'Task Income' ? 'selected' : '' }}>Task Income</option>
                                        <option value="Leadership Ranks and Rewards" {{ request('search') == 'Leadership Ranks and Rewards' ? 'selected' : '' }}>Leadership Ranks and Rewards</option>
                                    </select>
                                      <button
                                        type="submit"
                                        class="search-button"
                                    ...
                                    <div data-v-01110b5f="" class="item">
                                        <div data-v-01110b5f="" class="left">
                                            <div data-v-01110b5f="" class="type">{{$value->remarks}} <?=($value->remarks=="Direct Commission" || $value->remarks=="Quantify Level Income")?'Lvl-'.$value->level:''?></div>
                                            <div data-v-01110b5f="" class="time">{{ date('D, d M Y H:i:s', strtotime($value->created_at)) }}</div>
                                        </div>

                                        <div data-v-01110b5f="" class="right">
                                            <div data-v-01110b5f="" class="amount">{{$value->comm}} USDT</div>
                                            <div data-v-01110b5f="" class="status completed">completed<!----></div>
                                        </div>
                                    </div>
                                        @endforeach   
