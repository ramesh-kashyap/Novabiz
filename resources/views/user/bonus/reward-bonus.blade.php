...
<head>
    ...
    <title>Leadership Ranks and Rewards</title>
            ...
            <div data-v-e85f0186="" class="page-container">
                <div data-v-e85f0186="" class="scroll">
                    <div data-v-6a9399e1="" class="task-page">
                        <div data-v-6a9399e1="" class="title_heand">Leadership Ranks and Rewards</div>
                                                ...
                                                <div data-v-d3d46c3f="" class="item">
                                                    <div data-v-d3d46c3f="" class="item-top">
                                                        <div data-v-d3d46c3f="" class="left">
                                                            <div data-v-d3d46c3f="" class="title">🌟 *Manager Rank*</div>
                                                            <p data-v-d3d46c3f=""> Team Business: Achieve $20K in 6 layers 
                                                            </p>
                                                              <p data-v-d3d46c3f=""> Salary: $50 every 15 days </p>
                                                        </div>
                                                        <div data-v-d3d46c3f="" class="right"><span data-v-d3d46c3f=""
                                                                class="btn processing"> <?php echo ($first_lvl)?"Completed":"Pending";?> </span></div>
                                                    </div>
                                                    <!---->
                                                </div>
                                                <div data-v-d3d46c3f="" class="item">
                                                    <div data-v-d3d46c3f="" class="item-top">
                                                        <div data-v-d3d46c3f="" class="left">
                                                            <div data-v-d3d46c3f="" class="title">🌟 *GM Rank*</div>
                                                            <p data-v-d3d46c3f="">Team Business: Achieve $40K in 6 layers.
                                                            </p>
                                                            <p data-v-d3d46c3f="">Salary: $100 every 15 days.
                                                            </p>
                                                        </div>
                                                        <div data-v-d3d46c3f="" class="right"><span data-v-d3d46c3f=""
                                                                class="btn processing"><?php echo ($second_lvl)?"Completed":"Pending";?> </span></div>
                                                    </div>
                                                    <!---->
                                                </div>
                                                <div data-v-d3d46c3f="" class="item">
                                                    <div data-v-d3d46c3f="" class="item-top">
                                                        <div data-v-d3d46c3f="" class="left">
                                                            <div data-v-d3d46c3f="" class="title">🌟 *Director Rank*</div>
                                                            <p data-v-d3d46c3f="">Team Business: Achieve $80K in 6 layers.</p>
                                                            <p data-v-d3d46c3f=""> Salary: $400 every 15 days.</p>
                                                        </div>
                                                        <div data-v-d3d46c3f="" class="right"><span data-v-d3d46c3f=""
                                                                class="btn processing"><?php echo ($third_lvl)?"Completed":"Pending";?></span></div>
                                                    </div>
                                                    <!---->
                                                </div>
