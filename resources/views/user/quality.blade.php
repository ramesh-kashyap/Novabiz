...
<head>
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/FloatingBubble-CClix_ZS.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/NoticePopup-BLXglNTf.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/NoticePopup-SnqEssf-.css">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/CustomerService-BmGRHZEi.js">
    ...
    <link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/index-Dt9S06-Q.js">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/icon_copy_min-DeS-a5w4.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/index-CN2cg-QD.css">
    <link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/index-Cc2J0-m7.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/index-Bt3boTzb.css">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/InsideHeader-NL9xUybu.js">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/icon_back_white-Fd3ZFuzm.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/InsideHeader-k_Fsd2wZ.css">
    <link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/login-BH2qaMDs.js">
    ...
    <link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/index-D38F-0pH.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/index-BQpET14U.css">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/PhoneInp-o1Q6vdeS.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/PhoneInp-BbLd3uXE.css">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/ComCheckbox-BOQ8LZB9.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/ComCheckbox-DzGBGsDX.css">
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/AreaPopup-BnyFWO8A.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/ComList-DrBZve3J.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/LevelInfo-qeRJvLlS.js">
    <link rel="stylesheet" href="{{ asset('') }}assets/css/LevelInfo-yizkQ68A.css">
</head>
<style>
    .team-income[data-v-55773a97] {
        margin-bottom: .32rem;
        border-radius: .24rem;
        padding: .32rem;
        border-radius: .32rem;
        /* border: .02rem solid #854af6; */
        background: #fff;
        margin: 14px;
    }

    .team-income .income-center[data-v-55773a97] {
        display: flex;
    ...
    .team-income .income-center .num[data-v-55773a97] {
        color: #828284;
        font-size: .24rem;
        font-style: normal;
        font-weight: 400;
    ...
    .team-income .income-center .path[data-v-55773a97] {
        flex: 0 0 auto;
        margin-left: .2rem;
        border-radius: .28rem;
        /* background: #854af6; */
    ...
    .team-income .income-bot .item[data-v-55773a97] {
        min-width: 0;
        flex: 1;
        display: flex;
    ...
    .team-income .income-center .num div[data-v-55773a97] {
        color: #222;
        font-weight: 500;
        font-size: .32rem;
        margin-top: .12rem;
    ...
    .quantify-info .info-card .card-con .item .val[data-v-15322fef] {
        color: #fff;
        text-align: center;
        font-size: 0.28rem;
        font-style: normal;
...
<body class="">
    <div id="app" data-v-app="">
        ...
        <div data-v-e85f0186="" data-v-5a91a60a="" class="page" style="background-color: rgb(254, 254, 251);">
            <div data-v-e85f0186="" class="headers">
                <div data-v-f9fad449="" data-v-5a91a60a="" class="main-header">
                    ...
                    <div data-v-f9fad449="" class="right">
                        <a href="{{ route('user.record') }}">
                            <div data-v-5a91a60a="" class="header-right">Quantification Records</div>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div data-v-5a91a60a="" class="container">
                                ...
                                <div data-v-15322fef="" data-v-5a91a60a="" class="quantify-info">
                                    <div data-v-15322fef="" class="info-card">
                                        ...
                                        if ($balance >= 500 && $active_gen_team1total >= 3 && $active_gen_team2total+$active_gen_team3total>=5) {
                                            $quantifiable_count = 3;
                                        }
                                        if ($balance >= 2000 && $active_gen_team1total >= 6 && $active_gen_team2total+$active_gen_team3total>=12) {
                                            $quantifiable_count = 4;
                                        }
                                        
                                        if ($balance >= 5000 && $active_gen_team1total >= 12 && $active_gen_team2total+$active_gen_team3total>=30) {
                                            $quantifiable_count = 5;
                                        }
                                        if ($balance >=8000 && $active_gen_team1total >= 25 && $active_gen_team2total+$active_gen_team3total>=60) {
                                        ...
                                        <div data-v-15322fef="" class="time">
                                            <div data-v-15322fef="" class="lists">
                                                <div data-v-15322fef="" class="name">
                                                    <div data-v-15322fef="" class="n">@lang('Total Trade Earnings')
                                                    </div>
                                                    <div data-v-15322fef="" class="s">
                                                        {{ number_format($totalRoi, 2) }}
                                                    </div>
                                                </div>
                                                <div data-v-15322fef="" class="name">
                                                    <div data-v-15322fef="" class="n">@lang('Team Todays Earnings')
                                                    </div>
                                                    <div data-v-15322fef="" class="s">
                                                        {{ number_format($todaysLevelIncome, 2) }}</div>
                                                </div>
                                                <div data-v-15322fef="" class="name">
                                                    <div data-v-15322fef="" class="n">@lang('Total team income')</div>
                                                    <div data-v-15322fef="" class="s">
                                                        {{ number_format($totalLevelIncome, 2) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div data-v-15322fef="" class="card-con">
                                            <div data-v-15322fef="" class="item">
                                                <div data-v-15322fef="" class="val">
                                                    <?= Auth::user()->tradeAmt <= 0 && $todaysRoi < $quantifiable_count ? number_format($balance, 2) : number_format(Auth::user()->tradeAmt, 2) ?>
                                                    / {{ number_format($balance, 2) }}
                                                </div>
                                                <div data-v-15322fef="" class="name">@lang('Todays Quantifiable Amount')
                                                </div>
                                            </div>
                                            <div data-v-15322fef="" class="item">
                                                <div data-v-15322fef="" class="val">
                                                    {{ number_format($todaysRoiSum, 2) }}
                                                </div>
                                                <div data-v-15322fef="" class="name">@lang('Todays Earnings')</div>
                                            </div>
                                            <div data-v-15322fef="" class="item">
                                                ...
                                                <div data-v-15322fef="" class="name">@lang('Todays Quantifiable Count')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if ($lastTrade == null || Carbon::parse($lastTrade)->lt($today))
                                    <div data-v-f02e0afc="" data-v-5a91a60a="" class="quantify-execute"> <a
                                            href="{{ route('user.tradeOn') }}">

                                            <div data-v-f02e0afc="" class="start-btn"> @lang('Start Quantization')</div>
                                        </a>

                                    </div>
                                @else
                                    <div data-v-f02e0afc="" data-v-5a91a60a="" class="quantify-execute"
                                        style="opacity: 0.5; cursor: not-allowed;" disable>
                                        <div data-v-f02e0afc="" class="start-btn"> @lang('Start Quantization')</div>
                                    ...
                                    <div class="van-tabs__wrap">
                                        <div role="tablist"
                                            ...
                                            <div id="van-tabs-1-0" role="tab"
                                                class="van-tab van-tab--line van-tab--grow" tabindex="0"
                                                aria-selected="true" aria-controls="van-tab-2"><span
                                                    class="van-tab__text">

                                                    @if ($balance >= 50)
                                                        <div data-v-43c558e5="" class="level level2"
                                                            style="opacity: 1;">
                                                            <!--<img data-v-43c558e5=""-->
                                                            <!--    src="{{ asset('assets/images/vi1-DkyC-7lK.png') }}"-->
                                                            <!--    class="levelicon">-->
                                                            <div data-v-43c558e5="" class="level-name">VIP1</div>
                                                            @if ($balance >= 500 && $active_gen_team1total >= 3 && $active_gen_team2total+$active_gen_team3total>=5)
                                                                <div data-v-43c558e5="" class="test-tips statuson1">
                                                                    achieved
                                                                </div>
                                                            @else
                                                                <div data-v-43c558e5="" class="test-tips statuson1">
                                                            ...
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                                                    class="icon-lock-close icon icon-lock-open"></span>
                                                                Unlocked this level</div>
                                                        </div>
                                                    @else
                                                        <div data-v-43c558e5="" class="level level2"
                                                            style="opacity: 1;">
                                                            ...
                                                            <div data-v-43c558e5="" class="test-tips statuson1">Not
                                                                achieved
                                                            </div>
                                                            ...
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                                                    class="icon-lock-close icon icon-lock-open"></span>
                                                                Not unlocked this level yet</div>
                                                        </div>
                                                    @endif

                                                </span>
                                            </div>
                                            <div id="van-tabs-1-1" role="tab"
                                                ...
                                                aria-selected="false" aria-controls="van-tab-3"><span
                                                    ...
                                                    @if ($balance >= 500 && $active_gen_team1total >= 3 && $active_gen_team2total+$active_gen_team3total>=5)
                                                        ...
                                                        <div data-v-43c558e5="" class="level level3"
                                                            style="opacity: 1;">
                                                            <!--<img data-v-43c558e5=""-->
                                                            <!--    src="{{ asset('') }}assets/images/vi2-CCAxt9OI.png"-->
                                                            <!--    class="levelicon">-->
                                                            <div data-v-43c558e5="" class="level-name">VIP2</div>
                                                            @if ($balance >= 2000 && $active_gen_team1total >= 6 && $active_gen_team2total+$active_gen_team3total>=12)
                                                                <div data-v-43c558e5="" class="test-tips status2">
                                                                    achieved
                                                                </div>
                                                            @else
                                                                <div data-v-43c558e5="" class="test-tips status2">
                                                            ...
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                                                    class="icon-lock-close icon icon-lock-close"></span>
                                                                Unlocked this level</div>
                                                        </div>
                                                    @else
                                                        <div data-v-43c558e5="" class="level level3"
                                                            ...
                                                            <!--    class="levelicon">-->
                                                            <div data-v-43c558e5="" class="level-name">VIP2</div>
                                                            <div data-v-43c558e5="" class="test-tips status2">Not
                                                                achieved
                                                            </div>
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                            ...
                                            <div id="van-tabs-1-2" role="tab"
                                                class="van-tab van-tab--line van-tab--grow" tabindex="-1"
                                                aria-selected="false" aria-controls="van-tab-4"><span
                                                    class="van-tab__text">
                                                    @if ($balance >= 2000 && $active_gen_team1total >= 6 && $active_gen_team2total+$active_gen_team3total>=12)
                                                        <div data-v-43c558e5="" class="level level5"
                                                            style="opacity: 1;">
                                                            <img data-v-43c558e5=""
                                                                src="{{ asset('') }}assets/images/vi1-DkyC-7lK.png"
                                                                class="levelicon">
                                                            <div data-v-43c558e5="" class="level-name">VIP3</div>
                                                            <div data-v-43c558e5="" class="test-tips status3">achieved
                                                            </div>
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                                                    class="icon-lock-close icon icon-lock-close"></span>
                                                    ...
                                                    @else
                                                        <div data-v-43c558e5="" class="level level5"
                                                            ...
                                                            <img data-v-43c558e5=""
                                                                ...
                                                                class="levelicon">
                                                            <div data-v-43c558e5="" class="level-name">VIP3</div>
                                                            <div data-v-43c558e5="" class="test-tips status3">Not
                                                                achieved
                                                            </div>
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                            ...
                                            <div id="van-tabs-1-3" role="tab"
                                                class="van-tab van-tab--line van-tab--grow" tabindex="-1"
                                                aria-selected="false" aria-controls="van-tab-5"><span
                                                    class="van-tab__text">
                                                    @if ($balance >= 5000 && $active_gen_team1total >= 12 && $active_gen_team2total+$active_gen_team3total>=30)
                                                        <div data-v-43c558e5="" class="level level6"
                                                            style="opacity: 1;">
                                                            <img data-v-43c558e5=""
                                                                src="{{ asset('') }}assets/images/vi2-CCAxt9OI.png"
                                                                class="levelicon">
                                                            <div data-v-43c558e5="" class="level-name">VIP4</div>
                                                            <div data-v-43c558e5="" class="test-tips status3">achieved
                                                            </div>
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                            ...
                                            <div id="van-tabs-1-4" role="tab"
                                                class="van-tab van-tab--line van-tab--grow" tabindex="-1"
                                                aria-selected="false" aria-controls="van-tab-6"><span
                                                    class="van-tab__text">
                                                    @if ($balance >= 8000 && $active_gen_team1total >= 25 && $active_gen_team2total+$active_gen_team3total>=60)
                                                        <div data-v-43c558e5="" class="level level4"
                                                            style="opacity: 1;">
                                                            <img data-v-43c558e5=""
                                                                src="{{ asset('') }}assets/images/vi3-BxULMU4r.png"
                                                                class="levelicon">
                                                            <div data-v-43c558e5="" class="level-name">VIP5</div>
                                                            <div data-v-43c558e5="" class="test-tips status3">achieved
                                                            </div>
                                                            <div data-v-43c558e5="" class="level-updage"><span
                                                                    data-v-43c558e5=""
                                            ...
                                            <div class="van-tabs__line"
                                                style="transform: translateX(167.5px) translateX(-50%); transition-duration: 0.3s;">
                                            </div>
                                            <!---->
                                        </div>
                                    </div>
                                                            ...
                                                            <div data-v-21b9e3ce="" class="box">
                                                                ...
                                                                <div data-v-21b9e3ce="" class="box-con">
                                                                    <div data-v-21b9e3ce="" class="box-item">
                                                                        ...
                                                                        <div data-v-21b9e3ce="" class="val">50
                                                                        </div>
                                                                    </div>
                                                                    <div data-v-21b9e3ce="" class="box-item">
                                                                        <div data-v-21b9e3ce="" class="name">
                                                                            @lang('Maximum
                                                                                                                                                        amount quantification')</div>
                                                                        <div data-v-21b9e3ce="" class="val">499
                                                                        </div>
                                                                    </div>
                                                                    <div data-v-21b9e3ce="" class="box-item">
                                                                        <div data-v-21b9e3ce="" class="name">
                                                                        ...
                                                                        <div data-v-21b9e3ce="" class="val">2 times
                                                                        </div>
                                                                    </div>
                                                                    <div data-v-21b9e3ce="" class="box-item">
                                                                        <div data-v-21b9e3ce="" class="name">
                                                                            @lang('return on
                                                                                                                                                        investment')</div>
                                                                        <div data-v-21b9e3ce="" class="val">0.8% -
                                                                            1%
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    tabs.forEach((tab, index) => {
                        tab.addEventListener('click', function() {
                            ...
                            tabs.forEach(t => {
                                ...
                                'false'); // Updating ARIA for accessibility
                            });
                            contentPanels.forEach(panel => {
                                panel.style.display = 'none';
                                panel.setAttribute('aria-hidden',
                                'true'); // Make sure hidden panels are not focusable
                            });
                            ...
                            const offset = index *
                            500; // Change 500 to match the actual width of your content panels if different
                            // container.style.transform = `translateX(-${offset}px)`;
                            container.style.transitionDuration =
                            '500ms'; // Smooth transition for the sliding effect
                        });
                    });
