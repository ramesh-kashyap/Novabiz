...
<head>
	...
	<link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/PhoneInp-tEAipcGQ.js">
	...
	<link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/ComCheckbox-5wpZB3t6.js">
	...
	<link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/AreaPopup-w_5Z6uRT.js">
	...
	<link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/index-Cyf9hGR2.js">
	...
	<link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/index-CAhArD7G.js">
	...
	<link rel="modulepreload" as="script" crossorigin="" href="{{ asset('') }}assets/js/index-DkV8KR2D.js">
	<link rel="stylesheet" href="{{ asset('') }}assets/css/index-Cx888oIH.css">
	...
	<style>
		.box-con {
			...
			border-radius: .24rem;
			border: .02rem solid #cfd0ce;
		}

		.box-con[data-v-38000f34] {
			margin-top: .28rem;
			background: #fff;
			padding: .32rem;
			box-sizing: border-box;
		...
		.box-con .qr-con[data-v-38000f34] {
		...
		.box-con .address .address-input[data-v-38000f34] {
			font-size: .28rem;
			color: #828284;
			text-align: center;
		}

		.box-con .address .address-btn[data-v-38000f34] {
			margin-top: .4rem;
			background: #f7f7f7;
			border-radius: .2rem;
			text-align: center;
		...
		.box-con .inp-con .img[data-v-38000f34] {
			margin-right: .12rem;
			width: .56rem;
			height: .56rem;
			border-radius: 50%;
		...
		.box-con .inp-con[data-v-38000f34] {
			display: flex;
			align-items: center;
		}
...
<body class="">
	<div id="app" data-v-app="">
		...
		<div data-v-e85f0186="" data-v-8ad3dd38="" class="page" style="background-color: rgb(255, 255, 255);">
			<div data-v-e85f0186="" class="headers">
				<div data-v-54adc729="" data-v-e85f0186="" class="inside-header">
					<div data-v-54adc729="" class="left">
						<div data-v-54adc729="" class="back"> <a href="{{route('user.asset')}}"
								rel="noopener noreferrer"> <img data-v-54adc729=""
			...
			<div data-v-e85f0186="" class="page-container">
				<div data-v-e85f0186="" class="scroll">
					<div data-v-8ad3dd38="" class="container">
						<div data-v-8ad3dd38="" class="title_heand">@lang('Make Deposit')</div>
						<form method="post" name="add" action="{{ route('user.confirmDeposit') }}" data-v-8ad3dd38=""
							class="boxs">
							{{ csrf_field() }}
							<div data-v-8ad3dd38="" class="box">
                                <label data-v-8ad3dd38="" class="title">@lang('Select Payment Mode')</label>
                                <div data-v-8ad3dd38="" class="inp-con" style="margin-top:10px">
                                    <select data-v-8ad3dd38="" class="inp" type="text"  name="PSys">
							...
							<div data-v-8ad3dd38="" class="box">
                                <label data-v-8ad3dd38="" class="title">@lang('Select Payment Mode')</label>
                                <div data-v-8ad3dd38="" class="inp-con" style="margin-top:10px">
                                    <select data-v-8ad3dd38="" class="inp" type="number" name="Sum">
                                        <option value="100">100</option>
                                        <option value="200" >100</option>
                                    </select>
                                </div>
                            </div>
							<!--<div data-v-38000f34="" class="box-con">-->
							<!--	<div data-v-38000f34="" class="title">Select Currency</div>-->
							<!--	<div data-v-38000f34="" class="inp-con">-->
							<!--		<div data-v-38000f34="" class="inp">-->
							<!--			<div data-v-469e3332="" data-v-38000f34="" class="com-image img">-->
							<!--				<div data-v-469e3332="" class="van-image image"><img-->
							<!--						src="https://zscoo-all.s3.ap-southeast-1.amazonaws.com/upload/20240905/50793282687baa54dbdab67efbf68212.png"-->
							<!--						class="van-image__img" style="object-fit: cover;">-->
							<!--				</div>-->
							<!--			</div><span data-v-38000f34="" class="flex1">USDT</span>-->
							<!--		</div>-->
							<!--	</div>-->
							<!--</div>-->
							<!-- <div data-v-8ad3dd38="" class="box">
									<label data-v-8ad3dd38="" class="title">Email</label>
									<div data-v-8ad3dd38="" class="inp-con">
										<input data-v-8ad3dd38="" class="inp" type="text" value="TRC20">
									</div>
								</div> -->
							<!-- <div data-v-8ad3dd38="" class="box">
								<label data-v-8ad3dd38="" class="title">@lang('Enter Amount')</label>
								<div data-v-c7332cfe="" data-v-8ad3dd38="" class="inp-con" style="margin-top:10px">
									<div data-v-c7332cfe="" class="inp">
										<input data-v-c7332cfe="" type="number" name="Sum" value="10">
										<div data-v-c7332cfe="" class="code-btn"></div>
							...
							<div data-v-38000f34="" class="box-con">
								<div data-v-38000f34="" class="title">Select Mainnet</div>
								<div data-v-38000f34="" class="inp-con">
									<div data-v-38000f34="" class="inp">
										<div data-v-469e3332="" data-v-38000f34="" class="com-image img">
											<div data-v-469e3332="" class="van-image image"><img
										...
										</div><span data-v-38000f34="" class="flex1">USDT (BEP20)</span>
											
									</div>
								</div>
							</div>
							<!-- <div data-v-38000f34="" class="box-con">
								<div data-v-38000f34="" class="qr-con">
									<div data-v-38000f34="" title="TR5K1x6Z6SkZEwXTwVwzZgypx4thufC5eh"><canvas
											width="180" height="180" style="display: none;"></canvas><img alt="Scan me!" src="{{ $qrCodeLink }}"
											style="display: block;"></div>
								</div>
								<div data-v-38000f34="" class="address">
									<div data-v-38000f34=""  id="address" class="address-input">{{ $address_in }}
									</div>
									<div data-v-38000f34="" class="address-btn" onclick="copyAddress()">Copy address</div>
								</div>
							</div> -->
							<div data-v-8ad3dd38="" class="tips">
								<!-- <div data-v-8ad3dd38="" class="tip-title"><img data-v-8ad3dd38=""
                                    ...
                                    Warning</div> -->
								<!-- <div data-v-8ad3dd38="" class="tip-desc">To further secure your account, you need to
                                    complete the email verification before logging in</div> -->
							</div>
							<div data-v-8ad3dd38="" class="bot">
								<button data-v-359df9df="" data-v-8ad3dd38="" type="submit"
						...
						<div data-v-c654d101="" class="tips-con">
							<div data-v-c654d101="" class="title"><img data-v-c654d101=""
									src="data:image/png;base64,">
								Attention</div>
							<div data-v-c654d101="" class="desc">
								<div data-v-38000f34="" class="desc">
									

									<p> </p>

									<p>1. The minimum deposit amount is 50 USDT. If the amount is lower than the latest
										amount, it will not be available. </p>

									<p> </p>

									<p>2. The recharge address is USDT-BEP20, please check carefully before recharging.
									</p>

									<p> </p>

									<p>3. The deposit will be automatically credited within 3-5 minutes after the
										recharge is successful. </p>

									<p> </p>

									<p>4. You need to obtain the latest recharge address for each recharge. Please do
										not save the recharge address multiple times. </p>
								</div>
							</div>
						</div>
					</div>
				</div>
				<!--<div data-v-8b363259="" data-v-e85f0186="" class="touch-move-con" style="top: 1.0rem; right: 0.2rem;">-->
				<!--	<div data-v-a1dcde29="" data-v-e85f0186="" class="customer-service"><a-->
				<!--			href="https://t.me/bernila_vious" target="_blank"><img data-v-a1dcde29=""-->
