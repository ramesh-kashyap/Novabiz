                                        ...
                                        <div data-v-3aad496f="" role="feed" class="van-list" aria-busy="false">
                                            <div data-v-d3d46c3f="" data-v-6a9399e1="" class="list">
                                                ...
                                                <!-- <div data-v-d3d46c3f="" class="item">
                                                    <div data-v-d3d46c3f="" class="item-top">
                                                        <div data-v-d3d46c3f="" class="left">
                                                            <div data-v-d3d46c3f="" class="title">@lang('Inviting 100 valid user will reward you with 700 USDT')</div>
                                                            <p data-v-d3d46c3f="">@lang("If the number of invited users reaches 100, and the first deposit amount of these 100 people exceeds 100 USDT, they will be regarded as 100 valid users. This reward can only be obtained once and cannot  be obtained repeatedly.")</p>
                                                        </div>
                                                        <div data-v-d3d46c3f="" class="right"><span data-v-d3d46c3f=""
                                                                class="btn processing">{{($userDirect>=36)?"Completed":"In Progress"}}</span></div>
                                                    </div>
