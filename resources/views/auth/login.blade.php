            ...
            <div data-v-ebfcdf27="" class="headers">
                <div data-v-71170d5e="" data-v-7dfac6f0="" class="user-header">
                    <div data-v-71170d5e="" class="left">
                        <div data-v-71170d5e="" class="back"><img data-v-71170d5e=""
                ...
                <div data-v-ebfcdf27="" class="scroll">
                    <div data-v-7dfac6f0="" class="user">
                        <div data-v-7dfac6f0="" class="welcome-text"><img data-v-7dfac6f0=""
                            ...
                            <div data-v-7dfac6f0="">
                                <h2 data-v-7dfac6f0="">Welcome Back!</h2>
                                <p data-v-7dfac6f0="" style="font-size: smaller;">Enter Your Mobile And Password</p>
                            </div>
                        </div>
                        ...
                        <div data-v-7dfac6f0="" class="user-con">
                            <div data-v-7dfac6f0="" class="boxs">
                                <div data-v-7dfac6f0="" class="item">
                                    ...
                                    <div data-v-39429002="" data-v-7dfac6f0="" class="inp-con">
                                        <div data-v-39429002="" class="inp">
                                            ...
                                            </div><input data-v-39429002="" type="text"     name="phone"
                                ...
                                <div data-v-7dfac6f0="" class="item">
                                    ...
                                    <div data-v-8ad53e6c="" data-v-7dfac6f0="" class="inp-con">
                                        <div data-v-8ad53e6c="" class="inp"><input data-v-8ad53e6c="" id="passwordInput" type="password"
                                             name="password"
                                ...
                                <span class="van-checkbox__label">
                                  <span style="color: rgb(0, 0, 0);">rememberMe</span>
                                </span>
                                        </div>
                                        <div data-v-7dfac6f0="" class="forgot"><a href="{{route('forgot-password')}}">Forgot password？</a> </di>
                                    </div>
                                </div>
                            </div>
                            <div data-v-7dfac6f0="" class="bot"><button data-v-b1cead3b="" data-v-7dfac6f0=""
                                ...
                                <p data-v-7dfac6f0="">Don't have an account? <span data-v-7dfac6f0=""><a href="{{route('register')}}">Register
                                        now</a></span></p>
                            </div>
                        </div>
                    </div>
...
<script>
  function toggleCheckbox(el) {
    const icon = el.querySelector('.van-badge__wrapper');
    const check = el.querySelector('.check-icon');

    el.classList.toggle('van-checkbox__icon--checked');

    if (el.classList.contains('van-checkbox__icon--checked')) {
      icon.style.borderColor = 'rgb(19, 193, 164)';
      icon.style.backgroundColor = 'rgb(19, 193, 164)';
